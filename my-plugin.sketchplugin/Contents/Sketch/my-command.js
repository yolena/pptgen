...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  var sketch = __webpack_require__(/*! sketch/dom */ "sketch/dom"); // detects the currently opened document


  var document = __webpack_require__(/*! sketch/dom */ "sketch/dom").getSelectedDocument(); // gets the selected layers


  var selection = document.selectedLayers;
  sketch.export(selection.layers, {
    output: "~/my-plugin/pptgen/images",
    formats: 'png'
